function [Name,a] = Create_xyz
%GUI to create surface file from an xyz file

% ========= open new panel =============================================
d2 = dialog('Position',[300 300 250 500],'Name','Create xyz');
